...
const btnEncriptar = document.getElementById("boton_enc");
const btnDesencriptar = document.getElementById("boton_des");
...
function desencriptar() {
    let txtADesencriptar = res.value;
    let desencriptado= "";
